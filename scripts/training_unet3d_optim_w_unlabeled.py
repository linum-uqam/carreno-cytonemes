...
# adjustable settings
training_unet3d_base.out_model_name = "unet3d_optim_w_unlabeled.h5"
training_unet3d_base.wdb_project    = 'unet3d_optim_w_unlabeled'
...
training_unet3d_base.params = {
    ...
    'slftrn'   : True,           # pretrained encoder on unlabeled
    'dupe'     : 16              # nb d'usage pour un volume dans une époque
}

training_unet3d_base.main(verbose=0)