...
def training():
    ...
    base_model_name = "unet2d_gray_vs_rgb-3-30-0.98.h5"
    base_model_path = os.path.join(config['DIR']['model'], base_model_name)
    ...
    LR         = 0.0001
    model_name = sweep_config['project'] + "-" + str(backbone) + ".h5"
